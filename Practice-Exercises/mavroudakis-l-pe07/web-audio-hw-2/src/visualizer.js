...
let setupCanvas = (canvasElement, analyserNodeRef) => {
  ...
  gradient = utils.getLinearGradient(ctx, 0, 0, 0, canvasHeight, [{ percent: 0, color: "cyan" }, { percent: .3125, color: "blue" }, { percent: .6875, color: "rgb(128,0,255)" }, { percent: 1, color: "magenta" }]);
