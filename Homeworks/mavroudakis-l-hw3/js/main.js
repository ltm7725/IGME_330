...
function startGame() {
    ...
    document.querySelector("#backGuess").addEventListener("click", () => setGuess(viewRound - 1));
    document.querySelector("#forwardGuess").addEventListener("click", () => setGuess(viewRound + 1));
...
function tutorialPage7() {
    ...
    answerColor = new Color("a98rgb-linear", [document.querySelector("#colorValues").innerHTML.substring(document.querySelector("#colorValues").innerHTML.indexOf("(") + 1, document.querySelector("#colorValues").innerHTML.indexOf(",")) / 255, document.querySelector("#colorValues").innerHTML.substring(document.querySelector("#colorValues").innerHTML.indexOf(",") + 1, findNth(document.querySelector("#colorValues").innerHTML, ",", 2)) / 255, document.querySelector("#colorValues").innerHTML.substring(findNth(document.querySelector("#colorValues").innerHTML, ",", 2) + 1, findNth(document.querySelector("#colorValues").innerHTML, ",", 3)) / 255]);
...
function foreverLoop() {
    ...
    if (round > 1) {
        ...
        if (!x.matches) {
            ...
            document.querySelector("#guessButton").style.top = "3.75vw";
            ...
            document.querySelector("#slidersBack").style.top = "47.1vw";
            ...
            document.querySelector("#guessButton").style.top = "calc(138.7vh * .0375)";
            ...
            document.querySelector("#slidersBack").style.top = "calc(138.7vh * .471)";
        ...
        if (!x.matches) {
            ...
            document.querySelector("#slidersBack").style.top = "42vw";
            document.querySelector("#slidersBack").style.left = "42vw";
            ...
            for (let a of document.querySelectorAll(".arr-label")) {
                ...
                if(matchEndOrientation == 1) {
                    a.style.top = ".85vw";
                    a.style.marginBottom = "-5.45vw";
                }
                else if(matchEndOrientation == 2) {
            ...
            if (y.matches) {
                document.querySelector("#slidersBack").style.width = (document.body.clientHeight * 1.387 * .1375) + (document.body.clientHeight * 1.387 * .0275) * (.01 * -(document.body.clientHeight - 490)) + "px";
            ...
            document.querySelector("#slidersBack").style.top = "calc(138.7vh * .42)";
    ...
    if (window.matchMedia("(min-aspect-ratio: 946/540)").matches && round > 1) {
        document.querySelector("#tutButton3").style.top = (window.innerHeight * 0.2 / 1.9) - (document.querySelector("#tutButton3").clientHeight / 2) + "px";
        document.querySelector("#guessButton").style.top = (window.innerHeight * 0.2 / 1.9) - (document.querySelector("#guessButton").clientHeight / 2) + "px";
    }
}
...
function setGuess(historyRound) {
    ...
    document.querySelector("#historyPatch").style.backgroundColor = "rgb(" + colorGuesses[historyRound - 1][0] + "," + colorGuesses[historyRound - 1][1] + "," + colorGuesses[historyRound - 1][2] + ")";
...
function incrementRound() {
    ...
    answerColor = new Color(document.querySelector("#colorValues").innerHTML.substring(0, document.querySelector("#colorValues").innerHTML.indexOf(")") + 1));
    // answerColor = [document.querySelector("#colorValues").innerHTML.substring(document.querySelector("#colorValues").innerHTML.indexOf("(") + 1, document.querySelector("#colorValues").innerHTML.indexOf(",")) / 255, document.querySelector("#colorValues").innerHTML.substring(document.querySelector("#colorValues").innerHTML.indexOf(",") + 1, findNth(document.querySelector("#colorValues").innerHTML, ",", 2)) / 255, document.querySelector("#colorValues").innerHTML.substring(findNth(document.querySelector("#colorValues").innerHTML, ",", 2) + 1, findNth(document.querySelector("#colorValues").innerHTML, ",", 3)) / 255];
    ...
    console.log(document.querySelector("#colorValues").innerHTML.substring(0, document.querySelector("#colorValues").innerHTML.indexOf(")") + 1));
...
function endGame() {
    ...
    document.querySelector("#guessColor").style.backgroundColor = "rgb(" + theColor[0] + ", " + theColor[1] + ", " + theColor[2] + ")";
    document.querySelector("#answerColor").style.backgroundColor = "rgb(" + answerColor[0] + ", " + answerColor[1] + ", " + answerColor[2] + ")";
    document.querySelector("#game").style.position = "absolute";
    ...
    if(window.matchMedia("(min-aspect-ratio: 1000/721)").matches) matchEndOrientation = 2;
    else matchEndOrientation = 1;
}
